  ...
  <div class="container-fluid ">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo03">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        ...
        <li class=" h4 nav-item ">
        <Link className="nav-link active w-100 p-2" href="/#aboutpage"> About us
        </Link>     
         </li>
        <li class=" h4 nav-item">
        <Link className="nav-link active w-100 p-2" href="#" to="/treatmentspage">
                Treatments
              </Link>        </li>
        <li class=" h4 nav-item ">
        ...
        {isLoggedIn ? (
                  <li className="nav-item">
                    <Link className="nav-link active text-white w-100 p-2" to="/appointmentspage">
                      <button className='btn btn-outline-primary'>Book an appointment</button>
                    </Link>
                  </li>
                ) : (
                  <li className="nav-item">
                    <Link className='nav-link active text-white w-100 p-2' to="/loginpage"> 
                    <button className="btn btn-outline-primary ">Book an appointment</button>
                    </Link>
                  </li>
                )}
...

         {
          isLoggedIn ?(
            <li class="nav-item">
              <Link className="nav-link active text-white w-100 p-2" >
                <button className="btn btn-outline-primary" onClick={logouthandle} >Logout</button>
              </Link>
              </li>
